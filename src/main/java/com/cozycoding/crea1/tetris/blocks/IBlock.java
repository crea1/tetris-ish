 ...
 */
public class IBlock extends BlockRules implements TetrisBlock  {
    private static final Color color = new Color(0xCFFC31);
    /**
     * 0123
     */
    private Cell cell0 = new Cell(true, 3, 0, color);
    private Cell cell1 = new Cell(true, 4, 0, color);
    private Cell cell2 = new Cell(true, 5, 0, color);
    private Cell cell3 = new Cell(true, 6, 0, color);
    ...
    private List<Cell> rotateLeft() {
        cell0 = new Cell(true, cells.get(0).getX() + 2, cells.get(0).getY() - 1, color);
        cell1 = new Cell(true, cells.get(1).getX() + 1, cells.get(1).getY(), color);
        cell2 = new Cell(true, cells.get(2).getX(), cells.get(2).getY() + 1, color);
        cell3 = new Cell(true, cells.get(3).getX() - 1, cells.get(3).getY() + 2, color);
        return Arrays.asList(cell0, cell1, cell2, cell3);
    }

    private List<Cell> rotateUp() {
        cell0 = new Cell(true, cells.get(0).getX() + 1, cells.get(0).getY() + 2, color);
        cell1 = new Cell(true, cells.get(1).getX(), cells.get(1).getY() + 1, color);
        cell2 = new Cell(true, cells.get(2).getX() - 1, cells.get(2).getY(), color);
        cell3 = new Cell(true, cells.get(3).getX() - 2, cells.get(3).getY() - 1, color);
        return Arrays.asList(cell0, cell1, cell2, cell3);
    }
