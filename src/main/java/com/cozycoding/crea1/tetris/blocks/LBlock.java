 ...
 */
public class LBlock extends BlockRules implements TetrisBlock {
    private static final Color color = new Color(0x71ACED);
    /**
     * 012
     * 3
     */
    ...
    private Cell cell3 = new Cell(true, 4, 1, color);
