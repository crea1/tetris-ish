 ...
 */
public class SBlock extends BlockRules implements TetrisBlock {
    private static final Color color = new Color(0xCD6720);
    /**
     *  23
     * 01
     */

    private Cell cell0 = new Cell(true, 4, 1, color);
    private Cell cell1 = new Cell(true, 5, 1, color); // this is constant
