 ...
 */
public class ZBlock extends BlockRules implements TetrisBlock {
    private static final Color color = new Color(0xDDABEE);
    /**
     * 32
     *  10
     */

    private Cell cell0 = new Cell(true, 6, 1, color);
    private Cell cell1 = new Cell(true, 5, 1, color); // this is constant
    private Cell cell2 = new Cell(true, 5, 0, color);
    private Cell cell3 = new Cell(true, 4, 0, color);
